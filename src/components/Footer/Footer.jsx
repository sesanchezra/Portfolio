...
const Footer = () => {
    ...
    return (
        <div className='Footer'>
            <a  href="https://www.linkedin.com/in/sebastiansanchezramirez/" target='_blank' className='Footer__button'>
            ...
            <a href='https://github.com/sesanchezra' target='_blank' className='Footer__button'>
